...
class expedientPatient(models.Model):
    ...
    codeExpedient = models.CharField(verbose_name='Código del Expediente', max_length=10, unique=True)
    ...
    attedingPhysician = models.CharField(verbose_name='Médico a cargo', max_length=20)
