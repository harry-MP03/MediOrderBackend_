...
from Apps.Operaciones.DetallesEnfermedad.serializers import DetailDiseaseSerializer

#Para los reportes de los pedidos
from Apps.Catalogos.Paciente.serializers import PacienteSoporteExpedienteSerializer
...
class ExpedienteSerializer(ModelSerializer):
    ...
    enfermedades_detalles = DetailDiseaseSerializer(source='detailDiseaseFK', read_only=True, label='Enfermedad')
...
#Para repores de pedidos
class ExpedienteReporteSerializer(ModelSerializer):
    SoportePaciente = PacienteSoporteExpedienteSerializer(source='patientFK', read_only=True, label = 'Nombre y cedula del paciente')
    class Meta:
        model = expedientPatient
        fields = ['SoportePaciente']

class ExpedienteSoporteSerializer(ModelSerializer):
    class Meta:
        model = expedientPatient
