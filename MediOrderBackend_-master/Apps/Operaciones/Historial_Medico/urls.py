...
from .views import HistorialMedico_SoloActivosApiView,HistorialMedico_NoActivosApiView, ConteoActivosAPIView, \
    ConteoNoActivosAPIView, CamasDisponiblesAPIView, Listado_CamasDisponiblesAPIView, ReportesPedidosApiView
...
urlpatterns = [
    ...
    path("Reporte-PedidosDetallado", ReportesPedidosApiView.as_view()),
    # Obtener el listado de las camas disponibles
